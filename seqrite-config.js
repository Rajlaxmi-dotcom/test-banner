...
window.klaroConfig = {
  ...
  "uuid": "2e531b8a-aad6-4687-a3ec-1bfe25a17911",
  ...
  "translations": {
    "english": {
      ...
      "ok": "Accept All",
      "consentNotice": {
        "description": "<p><strong>We respect your privacy- EYOC</strong></p><p>We store cookies to enable essential site functionality, as well as marketing, personalization and analytics. By clicking “Accept All”, you consent to our use of cookies. You can change your settings at any time. <a href=\"https://www.google.com/\" title=\"https://www.google.com/\" target=\"_blank\"><u>Cookie Policy.</u></a></p>",
        "learnMore": "Customize",
        "changeDescription": " "
      },
      "save": "Accept",
      "consentModal": {
        "title": "<p>Customize Consent Preferences -EYOC2</p>",
    ...
    "ks": {
      ...
      "ok": "سٲری کر قبوٗل۔",
      "consentNotice": {
        "description": "أسۍ چھ تہنٛز راز دٲری ہنٛد احترام کران-EYOC أسۍ چھ ضروری سائٹچ فعالیتس سۭتۍ سۭتۍ مارکیٹنگ، پرسنلائزیشن تہٕ تجزیاتن فعال کرنہٕ خٲطرٕ کوکیز ذخیرٕ کران۔ \"تمام قبول کرو\" کلک کرتھ، تہۍ چھو سانۍ کوکیز استعمال کرنہٕ خٲطرٕ رضامند۔ تہۍ ہیٚکو کنہ تہ وقتہٕ پنٕنۍ سیٹنگہٕ تبدیل کٔرتھ۔ کوکی پالیسی۔",
        "learnMore": "کسٹمائز کر۔",
        "changeDescription": " "
      },
      "save": "قبول کرن۔",
      "consentModal": {
        "title": "رضامندی ہنز ترجیحات کر کسٹمائز-EYOC2",
      ...
      "purposes": {
        "Analytics": {
          "description": "یہ چھ کوکی اینالٹکس زمرہ۔"
        },
        "Others": {
          "description": "یہ چھ کوکی باقین ہنٛد زمرٕ۔"
        }
      },
      "service": {
        "disableAll": {
    ...
    "doi": {
      ...
      "purposes": {
        "Analytics": {
          "description": "एह् कुकी विश्लेषिकी वर्ग ऐ"
        },
        "Others": {
          "description": "एह् कुकी होरनें दी श्रेणी ऐ"
        }
      },
      "service": {
        "disableAll": {
    ...
    "ml": {
      ...
      "save": "സ്വീകരിക്കുക",
      "consentModal": {
        "title": "സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക-ഇ വൈ ഒ സി 2",
      ...
      "purposes": {
        "Analytics": {
          "description": "ഇത് കുക്കി അനലിറ്റിക്സ് വിഭാഗമാണ്"
        },
        "Others": {
          "description": "ഇത് കുക്കികൾ മറ്റുള്ളവരുടെ വിഭാഗമാണ്"
        }
      },
      "service": {
        "disableAll": {
    ...
    "mni": {
      ...
      "ok": "ꯄꯨꯝꯅꯃꯛ ꯂꯧꯕꯤꯌꯨ",
      "consentNotice": {
        "description": "ꯑꯩꯈꯣꯏꯅ ꯅꯍꯥꯛꯀꯤ ꯂꯟꯅꯥꯏꯕꯨ ꯏꯀꯥꯏ ꯈꯨꯝꯅꯩ-ꯏ. ꯋꯥꯏ. ꯑꯣ. ꯁꯤ. ꯑꯩꯈꯣꯏꯅ ꯇꯉꯥꯏꯐꯗꯕ ꯁꯥꯏꯠꯀꯤ ꯃꯊꯧ ꯇꯧꯕ ꯉꯝꯕ, ꯃꯥꯔꯀꯦꯇꯤꯡ, ꯄꯦꯁ ꯭ ꯅꯦꯜꯥꯏꯖꯦꯁꯟ ꯑꯃꯁꯨꯡ ꯑꯦꯅꯥꯂꯤꯇꯤꯛꯁ ꯇꯧꯕ ꯉꯝꯅꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯊꯝꯃꯤ ꯫ \"ꯄꯨꯝꯅꯃꯛ ꯌꯥꯕꯤꯌꯨ\" ꯍꯥꯏꯕ ꯑꯗꯨꯗ ꯅꯝꯗꯨꯅ, ꯅꯍꯥꯛꯅ ꯑꯩꯈꯣꯏꯒꯤ ꯀꯨꯀꯤꯁꯤꯡ ꯁꯤꯖꯤꯟꯅꯕ ꯌꯥꯔꯦ ꯫ ꯅꯍꯥꯛꯅ ꯃꯇꯝ ꯑꯃꯍꯦꯛꯇꯗ ꯅꯍꯥꯛꯀꯤ ꯁꯦꯇꯤꯡꯁ ꯑꯗꯨ ꯍꯣꯡꯗꯣꯛꯄ ꯌꯥꯏ ꯫ ꯀꯨꯀꯤꯒꯤ ꯊꯧꯁꯤꯜ ꯫",
        "learnMore": "ꯀꯁꯇꯃꯥꯏꯖ ꯇꯧ ꯫",
        "changeDescription": " "
      },
      "save": "ꯂꯧꯁꯤꯟꯕꯤꯌꯨ",
      "consentModal": {
        "title": "ꯀꯟꯁꯦꯟꯠ ꯄ ꯭ ꯔꯦꯐꯔꯦꯟꯁ-ꯏ. ꯋꯥꯏ. ꯑꯣ. ꯁꯤ. 2 ꯀꯁ ꯭ ꯇꯥꯃꯥꯏꯖ ꯇꯧ ꯫",
      ...
      "purposes": {
        "Analytics": {
          "description": "ꯃꯁꯤ ꯀꯨꯀꯤ ꯑꯦꯅꯥꯂꯥꯏꯇꯤꯛꯁꯀꯤ ꯀꯦꯇꯦꯒꯣꯔꯤꯅꯤ ꯫"
        },
        "Others": {
          "description": "ꯃꯁꯤ ꯀꯨꯀꯤ ꯑꯗꯔꯁ ꯀꯦꯇꯦꯒꯣꯔꯤꯅꯤ ꯫"
        }
      },
      "service": {
        "disableAll": {
    ...
    "sat": {
      ...
      "consentNotice": {
        "description": "ᱟᱢ ᱟᱢᱟᱜ ᱜᱚᱭᱱᱟᱥᱤ ᱨᱮᱭᱟᱜ ᱢᱟᱹᱱ ᱮᱢᱼᱟᱼ EYOC ᱟᱢ ᱫᱚ ᱵᱮᱼᱵᱟᱹᱛᱤᱞ ᱥᱟᱭᱤᱴ ᱠᱟᱹᱢᱤ ᱫᱟᱲᱮ ᱥᱟᱶ ᱥᱟᱶᱛᱮ ᱵᱟᱡᱟᱨ, ᱵᱮᱼᱵᱟᱹᱛᱤᱞ ᱟᱨ ᱚᱱᱚᱞᱤᱠᱤᱥ ᱠᱚᱨᱟᱣ ᱞᱟᱹᱜᱤᱫ ᱠᱩᱠᱤ ᱠᱚ ᱫᱚᱦᱚ ᱮᱫᱟ ᱾ \"ᱥᱟᱱᱟᱢᱟᱜ ᱦᱟᱛᱟᱣ ᱢᱮ\" ᱨᱮ ᱠᱞᱤᱠ ᱠᱟᱛᱮ, ᱟᱢ ᱤᱧᱟᱹᱜ ᱠᱩᱠᱤᱠᱚ ᱵᱮᱶᱦᱟᱨ ᱞᱟᱹᱜᱤᱫ ᱮ ᱥᱤᱜᱤᱞ ᱞᱮᱱᱟ ᱾ ᱟᱢ ᱡᱟᱦᱟᱸ ᱚᱠᱛᱚ ᱨᱮᱦᱚᱸ ᱟᱢᱟᱜ ᱥᱮᱴᱤᱝ ᱠᱚ ᱵᱚᱱᱚᱫᱚᱞ ᱫᱟᱲᱮᱭᱟᱜᱼᱟ ᱾ ᱠᱩᱠᱤ ᱟᱹᱨᱤ ᱾",
        "learnMore": "ᱠᱟᱥᱴᱚᱢᱟᱭᱤᱡ ᱢᱮ ᱾",
        "changeDescription": " "
      },
      "save": "ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
      "consentModal": {
        "title": "ᱥᱳᱯᱨᱩᱢᱟᱱᱟᱜ ᱠᱩᱥᱤᱭᱟᱱᱼᱮᱹᱣᱟᱭᱳᱥᱤᱹ2 ᱾",
      ...
      "purposes": {
        "Analytics": {
          "description": "ᱱᱚᱶᱟ ᱫᱚ ᱦᱩᱭᱩᱜ ᱠᱟᱱᱟ ᱠᱩᱠᱤ ᱚᱱᱚᱞᱮᱴᱤᱠᱥ ᱨᱮᱭᱟᱜ ᱦᱟᱹᱴᱤᱧ ᱾"
        },
        "Others": {
          "description": "ᱱᱚᱶᱟ ᱫᱚ ᱠᱩᱠᱤ ᱮᱴᱟᱜ ᱛᱷᱚᱱᱚᱛ ᱾"
        }
      },
      "service": {
        "disableAll": {
    ...
    "ur": {
      ...
      "ok": "سب کو قبول کریں",
      "consentNotice": {
        "description": "ہم آپ کی رازداری کا احترام کرتے ہیں-EYOC ہم سائٹ کی ضروری فعالیت کے ساتھ ساتھ مارکیٹنگ، شخصی کاری اور تجزیات کو فعال کرنے کے لیے کوکیز کو محفوظ کرتے ہیں۔ \"سب کو قبول کریں\" پر کلک کرکے، آپ ہمارے کوکیز کے استعمال سے اتفاق کرتے ہیں۔ آپ کسی بھی وقت اپنی ترتیبات تبدیل کر سکتے ہیں۔ کوکی پالیسی۔",
        "learnMore": "اپنی مرضی کے مطابق بنائیں",
        "changeDescription": " "
      },
      "save": "قبول کریں۔",
      "consentModal": {
        "title": "رضامندی کی ترجیحات کو حسب ضرورت بنائیں-ای وائی او سی 2",
      ...
      "purposes": {
        "Analytics": {
          "description": "یہ کوکی تجزیاتی زمرہ ہے"
        },
        "Others": {
          "description": "یہ کوکیز دیگر زمرہ ہے"
        }
      },
      "service": {
        "disableAll": {
    ...
    "brx": {
      ...
      "ok": "गासिबो नाजाव",
      "consentNotice": {
        "description": "जों नोंनि प्राइभेसिखौ मान होयो-EYOC जों गोनांथार साइटनि खामानिजों लोगोसे मार्केटिं, गावारि खालामनाय आरो एनालाइटिक्स खालामनो थाखाय कुकिफोरखौ दोनथुमो। \"गासिबो नाजाव\" आव क्लिक खालामनानै, नों जोंनि कुकिफोरनि बाहायनायखौ गनायो। नोंथाङा जायखिजाया समावनो गावनि सेटिंसखौ सोलायनो हायो। कुकि पलिसि।",
        "learnMore": "कास्टमाइज खालाम",
        "changeDescription": " "
      },
      "save": "नाजाव",
      "consentModal": {
        "title": "गनायथि सायख 'नायफोरखौ कास्टमाइज खालाम-ईवाईओसी2",
      ...
      "purposes": {
        "Analytics": {
          "description": "बेयो कुकि एनालिटिक्स थाखो"
        },
        "Others": {
          "description": "बेयो कुकिया गुबुनफोरनि थाखो"
        }
      },
      "service": {
        "disableAll": {
    ...
    "or": {
      ...
      "consentNotice": {
        "description": "ଆମେ ଆପଣଙ୍କ ଗୋପନୀୟତାକୁ ସମ୍ମାନ କରୁ-EYOC ଆମେ ଅତ୍ୟାବଶ୍ୟକ ସାଇଟ୍ କାର୍ଯ୍ୟକାରିତା, ତଥା ମାର୍କେଟିଂ, ବ୍ୟକ୍ତିଗତକରଣ ଏବଂ ବିଶ୍ଳେଷଣକୁ ସକ୍ଷମ କରିବାକୁ କୁକିଜ୍ ଷ୍ଟୋର୍ କରୁ। \"ସମସ୍ତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ\" ଉପରେ କ୍ଲିକ୍ କରି, ଆପଣ ଆମର କୁକିଜ୍ ବ୍ୟବହାର ପାଇଁ ରାଜି ହୁଅନ୍ତି। ଆପଣ ଯେକୌଣସି ସମୟରେ ନିଜର ସେଟିଂ ବଦଳାଇ ପାରିବେ। କୁକି ନୀତି।",
        "learnMore": "ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ",
        "changeDescription": " "
      },
      "save": "ଗ୍ରହଣ କରନ୍ତୁ",
      "consentModal": {
        "title": "ସମ୍ମତି ପସନ୍ଦ-ଇ. ୱାଇ. ଓ. ସି. 2 କୁ ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ",
      ...
      "purposes": {
        "Analytics": {
          "description": "ଏହା ହେଉଛି କୁକି ଆନାଲିଟିକ୍ସ ବର୍ଗ"
        },
        "Others": {
          "description": "ଏହା ହେଉଛି କୁକି ଅନ୍ୟ ବର୍ଗ"
        }
      },
      "service": {
        "disableAll": {
    ...
    "mr": {
      ...
      "ok": "सर्व स्वीकारा",
      "consentNotice": {
        "description": "आम्ही तुमच्या गोपनीयतेचा आदर करतो-ईवायओसी आम्ही आवश्यक साइट कार्यक्षमता, तसेच विपणन, वैयक्तिकरण आणि विश्लेषण सक्षम करण्यासाठी कुकीज संचयित करतो. \"सर्व स्वीकारा\" वर क्लिक करून, तुम्ही आमच्या कुकीजच्या वापरास संमती देता. तुम्ही कधीही तुमचे सेटिंग बदलू शकता. कुकी धोरण.",
        "learnMore": "सानुकूलित करा",
        "changeDescription": " "
      },
      "save": "स्वीकारा",
      "consentModal": {
        "title": "संमतीची प्राधान्ये सानुकूलित करा-ईवायओसी2",
      ...
      "purposes": {
        "Analytics": {
          "description": "ही कुकी विश्लेषण श्रेणी आहे"
        },
        "Others": {
          "description": "ही कुकी इतरांची श्रेणी आहे"
        }
      },
      "service": {
        "disableAll": {
    ...
    "as": {
      ...
      "ok": "সকলো গ্ৰহণ কৰক",
      "consentNotice": {
        "description": "আমি আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ-EYOC আমি অত্যাৱশ্যকীয় ছাইট কাৰ্য্যকৰীতা, লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি, আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰদান কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে। কুকি নীতি।",
        "learnMore": "স্বনিৰ্ধাৰিত কৰক",
        "changeDescription": " "
      },
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "সন্মতি পছন্দসমূহ অনুকূলিত কৰক-ই. ৱাই. অ '. চি. 2",
      ...
      "purposes": {
        "Analytics": {
          "description": "এইটো হৈছে কুকি এনালিটিক্স শ্ৰেণী"
        },
        "Others": {
          "description": "এইটো হৈছে কুকি আনৰ শ্ৰেণী"
        }
      },
      "service": {
        "disableAll": {
    ...
    "mai": {
      ...
      "consentNotice": {
        "description": "हम अहाँक गोपनीयता के सम्मान करैत छी-ईवाईओसी हम आवश्यक साइट कार्यक्षमता के संग-संग विपणन, वैयक्तिकरण आ विश्लेषण के सक्षम करै लेल कुकीज स्टोर करैत छी। \"सभ स्वीकार करू\" पर क्लिक कऽ अहाँ हमर कुकीजक उपयोगक लेल सहमति दैत छी। अहाँ कोनो समय अपन व्यवस्था बदल सकैत छी। कुकी नीति।",
        "learnMore": "अनुकूलित करू",
        "changeDescription": " "
      },
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "सहमति वरीयता-ईवाईओसी2 केँ अनुकूलित करू",
      ...
      "purposes": {
        "Analytics": {
          "description": "ई कुकी एनालिटिक्स श्रेणी अछि"
        },
        "Others": {
          "description": "ई कुकी अन्य श्रेणी अछि"
        }
      },
      "service": {
        "disableAll": {
    ...
    "ta": {
      ...
      "purposes": {
        "Analytics": {
          "description": "இது குக்கீ அனலிட்டிக்ஸ் வகை"
        },
        "Others": {
          "description": "இது குக்கீ மற்றவர்கள் வகை"
        }
      },
      "service": {
        "disableAll": {
    ...
    "sd": {
      ...
      "ok": "سڀ قبول ڪریو",
      "consentNotice": {
        "description": "اسان توہان جی رازداری جو احترام ڪریون ٿا-EYOC اسان ضروری سائیٽ جی ڪارڪردگی کی فعال ڪرڻ لاء ڪوڪی کی اسٽور ڪریون ٿا، گڏوگڏ مارڪیٽنگ، ذاتی ڪرڻ ۽ تجزیا ڪلڪ ڪندی \"سڀنی کی قبول ڪریو\" توہان اسان جی ڪوڪیز جی استعمال لاء رضامند آہیو توھان پنھنجی سیٽنگن کی ڪنھن بہ وقت تبدیل ڪری سگھو ٿا ڪوڪی پالسیء",
        "learnMore": "حسب ضرورت ٺاہیو",
        "changeDescription": " "
      },
      "save": "قبول ڪریو",
      "consentModal": {
        "title": "رضامندی جی ترجیحن کی ترتیب ڏیو-EYOC2",
      ...
      "purposes": {
        "Analytics": {
          "description": "ہی ڪوڪی اینالائیٽڪس ڪیٽیگری آھی"
        },
        "Others": {
          "description": "ہی ڪوڪی ٻین جی درجی آھی"
        }
      },
      "service": {
        "disableAll": {
    ...
    "bn": {
      ...
      "ok": "সব গ্রহণ করুন",
      "consentNotice": {
        "description": "আমরা আপনার গোপনীয়তাকে সম্মান করি-EYOC আমরা প্রয়োজনীয় সাইট কার্যকারিতা, পাশাপাশি বিপণন, ব্যক্তিগতকরণ এবং বিশ্লেষণ সক্ষম করতে কুকিজ সঞ্চয় করি। \"সবাইকে গ্রহণ করুন\"-এ ক্লিক করে, আপনি আমাদের কুকি ব্যবহারের জন্য সম্মত হন। আপনি যে কোনও সময় আপনার সেটিংস পরিবর্তন করতে পারেন। কুকি নীতি।",
        "learnMore": "কাস্টমাইজ করুন",
        "changeDescription": " "
      },
      "save": "গ্রহণ করুন",
      "consentModal": {
        "title": "সম্মতি পছন্দগুলি কাস্টমাইজ করুন-ইওয়াইওসি2",
      ...
      "purposes": {
        "Analytics": {
          "description": "এটি কুকি অ্যানালিটিক্স বিভাগ"
        },
        "Others": {
          "description": "এটি কুকি অন্যান্য বিভাগ"
        }
      },
      "service": {
        "disableAll": {
    ...
    "te": {
      ...
      "purposes": {
        "Analytics": {
          "description": "ఇది కుకీ అనలిటిక్స్ వర్గం"
        },
        "Others": {
          "description": "ఇది కుకీ ఇతరుల వర్గం"
        }
      },
      "service": {
        "disableAll": {
    ...
    "kn": {
      ...
      "purposes": {
        "Analytics": {
          "description": "ಇದು ಕುಕೀ ಅನಾಲಿಟಿಕ್ಸ್ ವರ್ಗವಾಗಿದೆ"
        },
        "Others": {
          "description": "ಇದು ಕುಕೀ ಇತರರ ವರ್ಗವಾಗಿದೆ"
        }
      },
      "service": {
        "disableAll": {
    ...
    "gu": {
      ...
      "ok": "બધાને સ્વીકારો",
      "consentNotice": {
        "description": "અમે તમારી ગોપનીયતાનો આદર કરીએ છીએ-EYOC અમે આવશ્યક સાઇટ કાર્યક્ષમતા, તેમજ માર્કેટિંગ, વ્યક્તિગતકરણ અને વિશ્લેષણને સક્ષમ કરવા માટે કૂકીઝ સંગ્રહિત કરીએ છીએ. \"બધા સ્વીકારો\" પર ક્લિક કરીને, તમે અમારા કૂકીઝના ઉપયોગ માટે સંમતિ આપો છો. તમે કોઈપણ સમયે તમારી સેટિંગ્સ બદલી શકો છો. કૂકી નીતિ.",
        "learnMore": "કસ્ટમાઇઝ કરો",
        "changeDescription": " "
      },
      "save": "સ્વીકારો",
      "consentModal": {
        "title": "સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો-EYOC2",
      ...
      "purposes": {
        "Analytics": {
          "description": "આ કૂકી એનાલિટિક્સ શ્રેણી છે"
        },
        "Others": {
          "description": "આ કૂકી અન્ય શ્રેણી છે"
        }
      },
      "service": {
        "disableAll": {
    ...
    "ne": {
      ...
      "consentNotice": {
        "description": "हामी तपाईंको गोपनीयतालाई सम्मान गर्दछौं-EYOC हामी आवश्यक साइट कार्यक्षमता, साथै मार्केटिङ, निजीकरण र विश्लेषण सक्षम गर्न कुकीहरू भण्डार गर्दछौं। \"सबै स्वीकार गर्नुहोस्\" मा क्लिक गरेर, तपाईं हाम्रो कुकीजको प्रयोगमा सहमत हुनुहुन्छ। तपाईँले कुनै पनि समयमा आफ्नो सेटिङहरू परिवर्तन गर्न सक्नुहुन्छ। कुकी नीति।",
        "learnMore": "अनुकूलित गर्नुहोस्",
        "changeDescription": " "
      },
      "save": "स्वीकार गर्नुहोस्",
      "consentModal": {
        "title": "सहमति प्राथमिकताहरू अनुकूलित गर्नुहोस्-इयोको2",
      ...
      "purposes": {
        "Analytics": {
          "description": "यो कुकी एनालिटिक्स श्रेणी हो"
        },
        "Others": {
          "description": "यो कुकी अन्य श्रेणी हो"
        }
      },
      "service": {
        "disableAll": {
    ...
    "hi": {
      ...
      "consentNotice": {
        "description": "हम आपकी गोपनीयता का सम्मान करते हैं-ईवाईओसी हम आवश्यक साइट कार्यक्षमता के साथ-साथ विपणन, वैयक्तिकरण और विश्लेषण को सक्षम करने के लिए कुकीज़ संग्रहीत करते हैं। \"सभी को स्वीकार करें\" पर क्लिक करके, आप कुकीज़ के हमारे उपयोग के लिए सहमत हैं। आप किसी भी समय अपनी सेटिंग बदल सकते हैं। कुकी नीति।",
        "learnMore": "अनुकूलित करें",
        "changeDescription": " "
      },
      "save": "स्वीकार करें",
      "consentModal": {
        "title": "सहमति वरीयताओं को अनुकूलित करें-ईवाईओसी2",
    ...
    "gom": {
      ...
      "ok": "सगळें मान्य कर",
      "consentNotice": {
        "description": "आमी तुमच्या गुप्ततायेचो आदर करतात-ईवायओसी आमी गरजेचीं सायट कार्यक्षमताय, तशेंच मार्केटींग, वैयक्तीकरण आनी विश्लेशण सक्षम करपा खातीर कुकीज सांठोवन दवरतात. \"सगळे मान्य करात\" क्लिक केल्यार, तुमी आमचे कुकीज वापरपाक मान्यताय दितात. तुमी खंयच्याय वेळार तुमची सेटिंग बदलूंक शकतात. कुकी धोरण.",
        "learnMore": "कस्टमायझ करात",
        "changeDescription": " "
      },
      "save": "स्विकार कर",
      "consentModal": {
        "title": "संमतीची पसंती सानुकूल करात-ईवायओसी2",
      ...
      "purposes": {
        "Analytics": {
          "description": "ही कुकी एनालिटिक्स श्रेणी आसा"
        },
        "Others": {
          "description": "ही कुकी हेर वर्ग आसा"
        }
      },
      "service": {
        "disableAll": {
    ...
    "pa": {
      ...
      "ok": "ਸਭ ਸਵੀਕਾਰ ਕਰੋ",
      "consentNotice": {
        "description": "ਅਸੀਂ ਤੁਹਾਡੀ ਗੋਪਨੀਯਤਾ ਦਾ ਸਨਮਾਨ ਕਰਦੇ ਹਾਂ-EYOC ਅਸੀਂ ਜ਼ਰੂਰੀ ਸਾਈਟ ਕਾਰਜਕੁਸ਼ਲਤਾ ਦੇ ਨਾਲ-ਨਾਲ ਮਾਰਕੀਟਿੰਗ, ਵਿਅਕਤੀਗਤਕਰਨ ਅਤੇ ਵਿਸ਼ਲੇਸ਼ਣ ਨੂੰ ਸਮਰੱਥ ਕਰਨ ਲਈ ਕੂਕੀਜ਼ ਨੂੰ ਸਟੋਰ ਕਰਦੇ ਹਾਂ। \"ਸਭ ਨੂੰ ਸਵੀਕਾਰ ਕਰੋ\" ਉੱਤੇ ਕਲਿਕ ਕਰਕੇ, ਤੁਸੀਂ ਸਾਡੀਆਂ ਕੂਕੀਜ਼ ਦੀ ਵਰਤੋਂ ਲਈ ਸਹਿਮਤੀ ਦਿੰਦੇ ਹੋ। ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਸਮੇਂ ਆਪਣੀਆਂ ਸੈਟਿੰਗਾਂ ਨੂੰ ਬਦਲ ਸਕਦੇ ਹੋ। ਕੂਕੀ ਨੀਤੀ.",
        "learnMore": "ਅਨੁਕੂਲਿਤ ਕਰੋ",
        "changeDescription": " "
      },
      "save": "ਸਵੀਕਾਰ ਕਰੋ",
      "consentModal": {
        "title": "ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ-ਈਵਾਈਓਸੀ2",
      ...
      "purposes": {
        "Analytics": {
          "description": "ਇਹ ਕੂਕੀ ਵਿਸ਼ਲੇਸ਼ਣ ਸ਼੍ਰੇਣੀ ਹੈ"
        },
        "Others": {
          "description": "ਇਹ ਕੂਕੀਜ਼ ਹੋਰ ਸ਼੍ਰੇਣੀ ਹੈ"
        }
      },
      "service": {
        "disableAll": {
    ...
    "sa": {
      ...
      "ok": "सर्वं स्वीकरोतु",
      "consentNotice": {
        "description": "वयं भवतः गोपनीयतायाः आदरं कुर्मः-ई. वै. ओ. सी. वयं आवश्यक-जालपुट-कार्यक्षमतां, अपि च विपणनं, वैयक्तिकरणं, विश्लेषणं च समर्थयितुं कुकीस् सञ्चालयामः। \"सर्वान् स्वीकरोतु\" इति क्लिक् कृत्वा, भवान् अस्माकं कुकीस् इत्यस्य उपयोगाय सम्मतिं ददति। भवान् कस्मिंश्चित् अपि स्वस्य सेट्टिङ्ग्स् परिवर्तयितुं शक्नोति। कुकी नीतिः।",
        "learnMore": "कस्टमैस् कुरु",
        "changeDescription": " "
      },
      "save": "स्वीकरोतु",
      "consentModal": {
        "title": "सहमतिप्राधान्यानि स्वकीयानि कुरु-ई. वै. ओ. सि. 2",
      ...
      "purposes": {
        "Analytics": {
          "description": "एषः कुकी-एनालिटिक्स् इति वर्गः अस्ति"
        },
        "Others": {
          "description": "एषा कुकी अन्याः प्रवर्गः अस्ति"
        }
      },
      "service": {
        "disableAll": {
    ...
    "it": {
      ...
      "purposes": {
        "Analytics": {
          "description": "Questa è la categoria di analisi dei cookie"
        },
        "Others": {
          "description": "Questo è un cookie Altro Categoria"
        }
      },
      "service": {
        "disableAll": {
