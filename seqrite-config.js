...
window.klaroConfig = {
  ...
  "uuid": "69e75adf-56a9-4511-9ca5-8731b6e4d332",
  ...
  "translations": {
    "english": {
      ...
      "ok": "Accept All",
      "consentNotice": {
        "description": "<p><strong>We respect your privacy - Banner, Opt OUT and Indian Languages for star</strong></p><p><strong>We store cookies to enable essential site functionality, as well as marketing, personalization and analytics. By clicking “Accept All”, you consent to our use of cookies. You can change your settings at any time. </strong><a href=\"https://www.google.com/\" title=\"https://www.google.com/\" target=\"_blank\"><strong><u>Cookie Policy.</u></strong></a></p>",
        "learnMore": "Customize",
        "changeDescription": " "
      },
      "save": "Accept",
      "consentModal": {
        "title": "<p>Customize Consent Preferences - <strong>Ovelay, Opt in and GT Languages</strong></p>",
        "description": "<p><strong>We use cookies to help you navigate between pages efficiently, storing your preferences, and generally improving your experience of a website. However, we acknowledge your right to privacy and hence you can choose not to allow some types of cookies. Click on the different category headings to find out more and change our default settings. Please note that blocking certain types of cookies might affect your experience of the site.</strong></p>",
        "buttons": {
          "save": "Accept",
          "acceptAll": "Accept all",
          "decline": "Reject All"
      ...
      "analytics": {
        "title": "Analytics",
        "description": "<p></p><p style=\"text-align:justify\">These cookies help us analyze website traffic, user behavior, and engagement patterns. The insights gathered allow us to optimize content, enhance usability, and improve overall site performance.</p><p></p><details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga</div><div><b>Host:</b>&nbsp;cookieconsenttestqa.netlify.app</div><div><b>Service:</b>&nbsp;Google Analytics</div></div></div></details>"
      },
      "others": {
        "title": "Others",
        "description": "<p></p><p style=\"text-align:justify\">This category includes cookies that do not fit into the predefined categories but may be necessary for certain website functionalities or improvements.</p><p></p><details style=\"margin-top:10px\"><summary style=\"cursor:pointer;font-weight:600;padding:2px 0\">1 Cookie</summary><div style=\"margin-top:6px;max-height:150px;overflow-y:auto\"><div style=\"padding:5px 0;border-bottom:1px solid rgba(0,0,0,0.07);font-size:12px;line-height:1.8\"><div><b>Name:</b>&nbsp;_ga_0000000001</div><div><b>Host:</b>&nbsp;cookieconsenttestqa.netlify.app</div><div><b>Service:</b>&nbsp;Google Analytics</div></div></div></details>"
      }
    },
    "en": {
      "acceptAll": "Accept all",
    ...
    "ks": {
      ...
      "ok": "سٲری کر قبوٗل۔",
      "consentNotice": {
        "description": "أسۍ چھ تہنٛز راز دٲری ہنٛد احترام کران-بینر، آپٹ آوٹ تہٕ انڈین لینگویجز فار سٹار أسۍ چھ ضروری سایٹہ ہٕنٛز فعالیت سۭتۍ مارکیٹنگ، پرسنلائزیشن تہٕ اینالیٹکس فعال کرنہٕ خٲطرٕ کوکیز سٹور کران۔ \"تمام قبول کرو\" کلک کرتھ، تہۍ چھو سانۍ کوکیز استعمال کرنہٕ خٲطرٕ رضامند۔ تہۍ ہیٚکو کنہ تہ وقتہٕ پنٕنۍ سیٹنگہٕ تبدیل کٔرتھ۔ کوکی پالیسی۔",
        "learnMore": "کسٹمائز کر۔",
        "changeDescription": " "
      },
      "save": "قبول کرن۔",
      "consentModal": {
        "title": "رضامندی ہنز ترجیحہٕ کر کسٹمائز-اویلے، آپٹ ان تہٕ جی ٹی زبانہٕ",
    ...
    "ml": {
      ...
      "consentNotice": {
        "description": "നിങ്ങളുടെ സ്വകാര്യതയെ ഞങ്ങൾ മാനിക്കുന്നു-ബാനർ, ഒപ്റ്റ് ഔട്ട്, ഇന്ത്യൻ ഭാഷകൾ ഫോർ സ്റ്റാർ അവശ്യ സൈറ്റ് പ്രവർത്തനക്ഷമത, മാർക്കറ്റിംഗ്, വ്യക്തിഗതമാക്കൽ, വിശകലനം എന്നിവ പ്രാപ്തമാക്കുന്നതിന് ഞങ്ങൾ കുക്കികൾ സംഭരിക്കുന്നു. \"എല്ലാം സ്വീകരിക്കുക\" ക്ലിക്കുചെയ്യുന്നതിലൂടെ, ഞങ്ങളുടെ കുക്കികളുടെ ഉപയോഗത്തിന് നിങ്ങൾ സമ്മതിക്കുന്നു. നിങ്ങൾക്ക് എപ്പോൾ വേണമെങ്കിലും നിങ്ങളുടെ ക്രമീകരണങ്ങൾ മാറ്റാം. കുക്കി നയം.",
        "learnMore": "ഇഷ്ടാനുസൃതമാക്കുക",
        "changeDescription": " "
      },
      "save": "സ്വീകരിക്കുക",
      "consentModal": {
        "title": "സമ്മത മുൻഗണനകൾ ഇഷ്ടാനുസൃതമാക്കുക-ഒവ്ലേ, ഒപ്റ്റ് ഇൻ, ജിടി ഭാഷകൾ",
    ...
    "mni": {
      ...
      "ok": "ꯄꯨꯝꯅꯃꯛ ꯂꯧꯕꯤꯌꯨ",
      "consentNotice": {
        "description": "ꯑꯩꯈꯣꯏꯅ ꯅꯍꯥꯛꯀꯤ ꯂꯟꯅꯥꯏ-ꯕꯦꯅꯔ, ꯑꯣꯞꯠ ꯑꯥꯎꯠ ꯑꯃꯁꯨꯡ ꯏꯟꯗꯤꯌꯟ ꯂꯡꯒ ꯭ ꯋꯦꯖꯁ ꯐꯣꯔ ꯁ ꯭ ꯇꯥꯔꯕꯨ ꯏꯀꯥꯏꯈꯨꯝꯅꯩ ꯑꯩꯈꯣꯏꯅ ꯇꯉꯥꯏꯐꯗꯕ ꯁꯥꯏꯠ ꯃꯊꯧ ꯇꯧꯕ ꯉꯝꯍꯟꯅꯕ ꯀꯨꯀꯤꯁꯤꯡ ꯊꯝꯃꯤ, ꯃꯁꯤꯒ ꯂꯣꯏꯅꯅ ꯃꯥꯔꯀꯦꯇꯤꯡ, ꯄꯦꯁ ꯭ ꯅꯂꯥꯏꯖꯦꯁꯟ ꯑꯃꯁꯨꯡ ꯑꯦꯅꯥꯂꯤꯇꯤꯛꯁꯁꯨ ꯇꯧꯋꯤ ꯫ \"ꯄꯨꯝꯅꯃꯛ ꯌꯥꯕꯤꯌꯨ\" ꯍꯥꯏꯕ ꯑꯗꯨꯗ ꯅꯝꯗꯨꯅ, ꯅꯍꯥꯛꯅ ꯑꯩꯈꯣꯏꯒꯤ ꯀꯨꯀꯤꯁꯤꯡ ꯁꯤꯖꯤꯟꯅꯕ ꯌꯥꯔꯦ ꯫ ꯅꯍꯥꯛꯅ ꯃꯇꯝ ꯑꯃꯍꯦꯛꯇꯗ ꯅꯍꯥꯛꯀꯤ ꯁꯦꯇꯤꯡꯁ ꯑꯗꯨ ꯍꯣꯡꯗꯣꯛꯄ ꯌꯥꯏ ꯫ ꯀꯨꯀꯤꯒꯤ ꯊꯧꯁꯤꯜ ꯫",
        "learnMore": "ꯀꯁꯇꯃꯥꯏꯖ ꯇꯧ ꯫",
        "changeDescription": " "
      },
ᱦᱟᱛᱟᱣ ᱢᱮ ᱾",
          "decline": "ᱥᱟᱱᱟᱢᱟᱜ ᱵᱟᱛᱟᱶ ᱢᱮ ᱾"
    ...
    "ur": {
      ...
      "ok": "سب کو قبول کریں",
      "consentNotice": {
        "description": "ہم آپ کی پرائیویسی کا احترام کرتے ہیں-بینر، آپٹ آؤٹ اور اسٹار کے لیے ہندوستانی زبانیں ہم سائٹ کی ضروری فعالیت کے ساتھ ساتھ مارکیٹنگ، پرسنلائزیشن اور تجزیات کو فعال کرنے کے لیے کوکیز اسٹور کرتے ہیں۔ \"سب کو قبول کریں\" پر کلک کرکے، آپ ہمارے کوکیز کے استعمال سے اتفاق کرتے ہیں۔ آپ کسی بھی وقت اپنی ترتیبات تبدیل کر سکتے ہیں۔ کوکی پالیسی۔",
        "learnMore": "اپنی مرضی کے مطابق بنائیں",
        "changeDescription": " "
      },
      "save": "قبول کریں۔",
      "consentModal": {
        "title": "رضامندی کی ترجیحات کو اپنی مرضی کے مطابق بنائیں-اوویلے، آپٹ ان اور جی ٹی زبانیں",
    ...
    "brx": {
      ...
      "ok": "गासिबो नाजाव",
      "consentNotice": {
        "description": "जों नोंनि प्राइभेसिखौ मान होयो-बेनार, अप्ट आउट आरो स्टारफोरनि थाखाय भारतारि रावफोर जों गोनांथार साइटनि खामानि मावनाय, लोगोसे मार्केटिं, गावारि खालामनाय आरो बिजिरसंनायखौ जाफुंसारहोनो थाखाय कुकिफोरखौ दोनथुमो। \"गासिबो नाजाव\" आव क्लिक खालामनानै, नों जोंनि कुकिफोरनि बाहायनायखौ गनायो। नोंथाङा जायखिजाया समावनो गावनि सेटिंसखौ सोलायनो हायो। कुकि पलिसि।",
        "learnMore": "कास्टमाइज खालाम",
        "changeDescription": " "
      },
      "save": "नाजाव",
      "consentModal": {
        "title": "गनायथि सायख 'नायफोरखौ कास्टमाइज खालाम-अवेले, अप्ट इन आरो जी. टी. रावफोर",
    ...
    "mr": {
      ...
      "ok": "सर्व स्वीकारा",
      "consentNotice": {
        "description": "आम्ही तुमच्या गोपनीयतेचा आदर करतो-बॅनर, ऑप्ट आउट आणि स्टारसाठी भारतीय भाषा आम्ही आवश्यक साइट कार्यक्षमता, तसेच विपणन, वैयक्तिकरण आणि विश्लेषण सक्षम करण्यासाठी कुकीज संचयित करतो. \"सर्व स्वीकारा\" वर क्लिक करून, तुम्ही आमच्या कुकीजच्या वापरास संमती देता. तुम्ही कधीही तुमचे सेटिंग बदलू शकता. कुकी धोरण.",
        "learnMore": "सानुकूलित करा",
        "changeDescription": " "
      },
      "save": "स्वीकारा",
      "consentModal": {
        "title": "संमतीची प्राधान्ये सानुकूलित करा-ओवले, निवड आणि जी. टी. भाषा",
    ...
    "or": {
      ...
      "consentNotice": {
        "description": "ଆମେ ଆପଣଙ୍କ ଗୋପନୀୟତାକୁ ସମ୍ମାନ କରୁ-ବ୍ୟାନର, ଅପ୍ଟ ଆଉଟ ଏବଂ ଭାରତୀୟ ଭାଷାଗୁଡ଼ିକ ଆମେ ଅତ୍ୟାବଶ୍ୟକ ସାଇଟର କାର୍ଯ୍ୟକାରିତା ତଥା ବିପଣନ, ବ୍ୟକ୍ତିଗତକରଣ ଏବଂ ବିଶ୍ଳେଷଣକୁ ସକ୍ଷମ କରିବା ପାଇଁ କୁକିଜ ଷ୍ଟୋର କରୁ। \"ସମସ୍ତଙ୍କୁ ଗ୍ରହଣ କରନ୍ତୁ\" ଉପରେ କ୍ଲିକ୍ କରି, ଆପଣ ଆମର କୁକିଜ୍ ବ୍ୟବହାର ପାଇଁ ରାଜି ହୁଅନ୍ତି। ଆପଣ ଯେକୌଣସି ସମୟରେ ନିଜର ସେଟିଂ ବଦଳାଇ ପାରିବେ। କୁକି ନୀତି।",
        "learnMore": "ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ",
        "changeDescription": " "
      },
      "save": "ଗ୍ରହଣ କରନ୍ତୁ",
      "consentModal": {
        "title": "ସମ୍ମତି ପସନ୍ଦଗୁଡ଼ିକୁ ସ୍ୱତନ୍ତ୍ର କରନ୍ତୁ-'ଓଭଲେ \",' ଅପ୍ଟ ଇନ୍\" ଏବଂ 'ଜି. ଟି. ଭାଷା \"",
    ...
    "mai": {
      ...
      "consentNotice": {
        "description": "हम अहाँक गोपनीयता के सम्मान करैत छी-बैनर, ऑप्ट आउट आ स्टार लेल भारतीय भाषा हम आवश्यक साइट कार्यक्षमता के संग-संग विपणन, वैयक्तिकरण आ विश्लेषण के सक्षम करै लेल कुकीज स्टोर करैत छी। \"सभ स्वीकार करू\" पर क्लिक कऽ अहाँ हमर कुकीजक उपयोगक लेल सहमति दैत छी। अहाँ कोनो समय अपन व्यवस्था बदल सकैत छी। कुकी नीति।",
        "learnMore": "अनुकूलित करू",
        "changeDescription": " "
      },
      "save": "स्वीकार करू",
      "consentModal": {
        "title": "सहमति वरीयता केँ अनुकूलित करू-ओवेल, ऑप्ट इन आ जीटी भाषा",
    ...
    "as": {
      ...
      "ok": "সকলো গ্ৰহণ কৰক",
      "consentNotice": {
        "description": "আমি আপোনাৰ গোপনীয়তাক সন্মান কৰোঁ-বেনাৰ, অপ্ট আউট আৰু ষ্টাৰৰ বাবে ভাৰতীয় ভাষাসমূহ আমি অত্যাৱশ্যকীয় ছাইট কাৰ্য্যকৰীতা, লগতে বিপণন, ব্যক্তিগতকৰণ আৰু বিশ্লেষণ সক্ষম কৰিবলৈ কুকিজ সংৰক্ষণ কৰোঁ। \"সকলো গ্ৰহণ কৰক\" ক্লিক কৰি, আপুনি আমাৰ কুকিজৰ ব্যৱহাৰত সন্মতি প্ৰদান কৰে। আপুনি যিকোনো সময়তে আপোনাৰ ছেটিংছ সলনি কৰিব পাৰে। কুকি নীতি।",
        "learnMore": "স্বনিৰ্বাচিত কৰক",
        "changeDescription": " "
      },
      "save": "গ্ৰহণ কৰক",
      "consentModal": {
        "title": "সন্মতিৰ পছন্দসমূহ অনুকূলিত কৰক-অ 'ভেলে, অপ্ট ইন আৰু জি. টি. ভাষাসমূহ",
    ...
    "bn": {
      ...
      "ok": "সব গ্রহণ করুন",
      "consentNotice": {
        "description": "আমরা আপনার গোপনীয়তাকে সম্মান করি-ব্যানার, অপ্ট আউট এবং ইন্ডিয়ান ল্যাঙ্গুয়েজেস ফর স্টার আমরা প্রয়োজনীয় সাইট কার্যকারিতা, পাশাপাশি বিপণন, ব্যক্তিগতকরণ এবং বিশ্লেষণ সক্ষম করতে কুকিজ সঞ্চয় করি। \"সবাইকে গ্রহণ করুন\"-এ ক্লিক করে, আপনি আমাদের কুকি ব্যবহারের জন্য সম্মত হন। আপনি যে কোনও সময় আপনার সেটিংস পরিবর্তন করতে পারেন। কুকি নীতি।",
        "learnMore": "কাস্টমাইজ করুন",
        "changeDescription": " "
      },
      "save": "গ্রহণ করুন",
      "consentModal": {
        "title": "সম্মতি পছন্দগুলি কাস্টমাইজ করুন-ওভেল, অপ্ট ইন এবং জিটি ভাষা",
    ...
    "te": {
      ...
      "consentNotice": {
        "description": "మేము మీ గోప్యతను గౌరవిస్తాము-బ్యానర్, ఆప్ట్ అవుట్ మరియు స్టార్ కోసం భారతీయ భాషలు మేము అవసరమైన సైట్ కార్యాచరణను, అలాగే మార్కెటింగ్, వ్యక్తిగతీకరణ మరియు విశ్లేషణలను ప్రారంభించడానికి కుకీలను నిల్వ చేస్తాము. \"అందరినీ అంగీకరించండి\" పై క్లిక్ చేయడం ద్వారా, మీరు మా కుకీల వినియోగానికి అంగీకరిస్తారు. మీరు ఎప్పుడైనా మీ సెట్టింగులను మార్చుకోవచ్చు. కుకీ విధానం.",
        "learnMore": "అనుకూలీకరించండి",
        "changeDescription": " "
      },
      "save": "అంగీకరించండి",
      "consentModal": {
        "title": "సమ్మతి ప్రాధాన్యతలను అనుకూలీకరించండి-ఒవేలే, ఆప్ట్ ఇన్ మరియు జిటి భాషలు",
    ...
    "gu": {
      ...
      "ok": "બધાને સ્વીકારો",
      "consentNotice": {
        "description": "અમે તમારી ગોપનીયતાનો આદર કરીએ છીએ-બૅનર, ઓપ્ટ આઉટ અને સ્ટાર માટે ભારતીય ભાષાઓ અમે આવશ્યક સાઇટ કાર્યક્ષમતા, તેમજ માર્કેટિંગ, વ્યક્તિગતકરણ અને વિશ્લેષણને સક્ષમ કરવા માટે કૂકીઝ સંગ્રહિત કરીએ છીએ. \"બધા સ્વીકારો\" પર ક્લિક કરીને, તમે અમારા કૂકીઝના ઉપયોગ માટે સંમતિ આપો છો. તમે કોઈપણ સમયે તમારી સેટિંગ્સ બદલી શકો છો. કૂકી નીતિ.",
        "learnMore": "કસ્ટમાઇઝ કરો",
        "changeDescription": " "
      },
      "save": "સ્વીકારો",
      "consentModal": {
        "title": "સંમતિ પસંદગીઓને કસ્ટમાઇઝ કરો-ઓવેલ, ઓપ્ટ ઇન અને જીટી ભાષાઓ",
    ...
    "kn": {
      ...
      "consentNotice": {
        "description": "ನಿಮ್ಮ ಗೌಪ್ಯತೆಯನ್ನು ನಾವು ಗೌರವಿಸುತ್ತೇವೆ-ಬ್ಯಾನರ್, ಆಪ್ಟ್ ಔಟ್ ಮತ್ತು ಸ್ಟಾರ್ಗಾಗಿ ಭಾರತೀಯ ಭಾಷೆಗಳು ನಾವು ಅಗತ್ಯ ಸೈಟ್ ಕಾರ್ಯವನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಲು ಕುಕೀಗಳನ್ನು ಸಂಗ್ರಹಿಸುತ್ತೇವೆ, ಜೊತೆಗೆ ಮಾರ್ಕೆಟಿಂಗ್, ವೈಯಕ್ತೀಕರಣ ಮತ್ತು ವಿಶ್ಲೇಷಣೆ. \"ಎಲ್ಲರನ್ನೂ ಸ್ವೀಕರಿಸಿ\" ಕ್ಲಿಕ್ ಮಾಡುವ ಮೂಲಕ, ನೀವು ನಮ್ಮ ಕುಕೀಗಳ ಬಳಕೆಯನ್ನು ಒಪ್ಪುತ್ತೀರಿ. ನೀವು ಯಾವುದೇ ಸಮಯದಲ್ಲಿ ನಿಮ್ಮ ಸೆಟ್ಟಿಂಗ್ಗಳನ್ನು ಬದಲಾಯಿಸಬಹುದು. ಕುಕೀ ನೀತಿ.",
        "learnMore": "ಕಸ್ಟಮೈಸ್ ಮಾಡಿ",
        "changeDescription": " "
      },
      "save": "ಸ್ವೀಕರಿಸಿ",
      "consentModal": {
        "title": "ಒಪ್ಪಿಗೆಯ ಆದ್ಯತೆಗಳನ್ನು ಕಸ್ಟಮೈಸ್ ಮಾಡಿ-ಓವೆಲೆ, ಆಪ್ಟ್ ಇನ್ ಮತ್ತು ಜಿಟಿ ಭಾಷೆಗಳು",
    ...
    "ne": {
      ...
      "consentNotice": {
        "description": "हामी तपाईंको गोपनीयतालाई सम्मान गर्दछौं-ब्यानर, अप्ट आउट र स्टारका लागि भारतीय भाषाहरू हामीले आवश्यक साइट कार्यक्षमता, साथै मार्केटिङ, निजीकरण र विश्लेषण सक्षम गर्न कुकीहरू भण्डार गर्दछौं। \"सबै स्वीकार गर्नुहोस्\" मा क्लिक गरेर, तपाईं हाम्रो कुकीजको प्रयोगमा सहमत हुनुहुन्छ। तपाईँले कुनै पनि समयमा आफ्नो सेटिङहरू परिवर्तन गर्न सक्नुहुन्छ। कुकी नीति।",
        "learnMore": "अनुकूलित गर्नुहोस्",
        "changeDescription": " "
      },
      "save": "स्वीकार गर्नुहोस्",
      "consentModal": {
        "title": "सहमति प्राथमिकताहरू अनुकूलित गर्नुहोस्-ओभेले, अप्ट इन र जीटी भाषाहरू",
    ...
    "hi": {
      ...
      "consentNotice": {
        "description": "हम आपकी गोपनीयता का सम्मान करते हैं-बैनर, ऑप्ट आउट और स्टार के लिए भारतीय भाषाएँ हम आवश्यक साइट कार्यक्षमता के साथ-साथ विपणन, वैयक्तिकरण और विश्लेषण को सक्षम करने के लिए कुकीज़ संग्रहीत करते हैं। \"सभी को स्वीकार करें\" पर क्लिक करके, आप कुकीज़ के हमारे उपयोग के लिए सहमत हैं। आप किसी भी समय अपनी सेटिंग बदल सकते हैं। कुकी नीति।",
        "learnMore": "अनुकूलित करें",
        "changeDescription": " "
      },
      "save": "स्वीकार करें",
      "consentModal": {
        "title": "सहमति वरीयताओं को अनुकूलित करें-ओवेल, ऑप्ट इन और जी. टी. भाषाएँ",
    ...
    "gom": {
      ...
      "ok": "सगळें मान्य कर",
      "consentNotice": {
        "description": "आमी तुमच्या गुप्ततायेचो आदर करतात-बॅनर, ऑप्ट आउट आनी स्टार खातीर भारतीय भाशे आमी गरजेच्यो संकेतथळ कार्यक्षमताय, तशेंच विपणन, वैयक्तीकरण आनी विश्लेशण सक्षम करपा खातीर कुकीज सांठोवन दवरतात. \"सगळे मान्य करात\" क्लिक केल्यार, तुमी आमचे कुकीज वापरपाक मान्यताय दितात. तुमी खंयच्याय वेळार तुमची सेटिंग बदलूंक शकतात. कुकी धोरण.",
        "learnMore": "कस्टमायझ करात",
        "changeDescription": " "
      },
      "save": "स्विकार कर",
      "consentModal": {
        "title": "संमतीची पसंती सानुकूल करात-ओवेल, निवड आनी जी. टी. भाशे",
    ...
    "pa": {
      ...
      "ok": "ਸਭ ਸਵੀਕਾਰ ਕਰੋ",
      "consentNotice": {
        "description": "ਅਸੀਂ ਤੁਹਾਡੀ ਗੋਪਨੀਯਤਾ ਦਾ ਸਨਮਾਨ ਕਰਦੇ ਹਾਂ-ਬੈਨਰ, ਆਪਟ ਆਊਟ ਅਤੇ ਸਟਾਰ ਲਈ ਭਾਰਤੀ ਭਾਸ਼ਾਵਾਂ ਅਸੀਂ ਜ਼ਰੂਰੀ ਸਾਈਟ ਕਾਰਜਕੁਸ਼ਲਤਾ ਦੇ ਨਾਲ-ਨਾਲ ਮਾਰਕੀਟਿੰਗ, ਵਿਅਕਤੀਗਤਕਰਨ ਅਤੇ ਵਿਸ਼ਲੇਸ਼ਣ ਨੂੰ ਸਮਰੱਥ ਬਣਾਉਣ ਲਈ ਕੂਕੀਜ਼ ਨੂੰ ਸਟੋਰ ਕਰਦੇ ਹਾਂ। \"ਸਭ ਨੂੰ ਸਵੀਕਾਰ ਕਰੋ\" ਉੱਤੇ ਕਲਿਕ ਕਰਕੇ, ਤੁਸੀਂ ਸਾਡੀਆਂ ਕੂਕੀਜ਼ ਦੀ ਵਰਤੋਂ ਲਈ ਸਹਿਮਤੀ ਦਿੰਦੇ ਹੋ। ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਸਮੇਂ ਆਪਣੀਆਂ ਸੈਟਿੰਗਾਂ ਨੂੰ ਬਦਲ ਸਕਦੇ ਹੋ। ਕੂਕੀ ਨੀਤੀ.",
        "learnMore": "ਅਨੁਕੂਲਿਤ ਕਰੋ",
        "changeDescription": " "
      },
      "save": "ਸਵੀਕਾਰ ਕਰੋ",
      "consentModal": {
        "title": "ਸਹਿਮਤੀ ਤਰਜੀਹਾਂ ਨੂੰ ਅਨੁਕੂਲਿਤ ਕਰੋ-ਓਵਲੇ, ਆਪਟ ਇਨ ਅਤੇ ਜੀ. ਟੀ. ਭਾਸ਼ਾਵਾਂ",
    ...
    "sa": {
      ...
      "ok": "सर्वं स्वीकरोतु",
      "consentNotice": {
        "description": "वयं भवतः गोपनीयतायाः आदरं कुर्मः-ब्यानर्, आप्ट् औट् तथा भारतीयभाषाः स्टार्-कृते वयं आवश्यक-जालपुट-कार्यक्षमतां समर्थयितुं कुकीस् सञ्चालयामः, तथैव विपणनं, वैयक्तिकरणं तथा विश्लेषणं च। \"सर्वान् स्वीकरोतु\" इति क्लिक् कृत्वा, भवान् अस्माकं कुकीस् इत्यस्य उपयोगाय सम्मतिं ददति। भवान् कस्मिंश्चित् अपि स्वस्य सेट्टिङ्ग्स् परिवर्तयितुं शक्नोति। कुकी नीतिः।",
        "learnMore": "कस्टमैस् कुरु",
        "changeDescription": " "
      },
      "save": "स्वीकरोतु",
      "consentModal": {
        "title": "सम्मतिप्राधान्यानि स्वकीयानि करोतु-ओवेल्, आप्ट् इन् तथा जी. टी. भाषाः",
